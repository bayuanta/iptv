...
async def main() -> None:
    ...
    for event_name, event_info in sorted(additions.items()):
        ...
        banned_sports = ["BASKETBALL", "VOLLEYBALL", "TENNIS", "WIMBLEDON", "MLB", "BASEBALL", "NFL", "F1", "MOTOGP", "UFC", "BOXING", "CRICKET", "RUGBY", "GOLF"]
        if any(banned in name_upper for banned in banned_sports):
            continue
            
        # Memastikan aroma kompetisi sepakbola kaki tetap terjaga
        keywords_bola = ["FOOTBALL", "SOCCER", "LIGA", "LEAGUE", "CUP", "UEFA", "FIFA", "COPA", "CHAMPIONSHIP", "VS", "X"]
